...
export default async function Home() {
  ...
  return (
    <div className="bg-white min-h-screen font-sans">
      ...
      <section className="py-24 bg-gray-50 border-b border-gray-200">
         <div className="max-w-[1200px] mx-auto px-4">
            <div className="text-center mb-12">
               ...
               <h2 className="text-4xl md:text-5xl font-extrabold text-dark-900 mt-2">O que você quer viver hoje?</h2>
            </div>
                  ...
                  return (
                    <Link href={`/products?category=${cat.slug}`} key={cat.id} className="group flex flex-col items-center gap-3 cursor-pointer">
                       <div className="flex items-center justify-center transition-transform duration-300 group-hover:scale-110">
                          <IconComponent size={36} strokeWidth={1.5} className="text-dark-900 group-hover:text-brand-500 transition-colors" />
                       </div>
                       <span className="text-sm font-bold text-dark-900 group-hover:text-brand-500 transition-colors">{cat.name}</span>
                    </Link>
                  );
               })}
            </div>
      ...
      <section className="py-20 bg-white">
         <div className="max-w-[1200px] mx-auto px-4">
            <div className="flex justify-between items-end mb-10 border-b border-gray-100 pb-4">
               <div>
                  <h2 className="text-4xl md:text-5xl font-extrabold text-dark-900">Favoritos Foz Turismo SM</h2>
      ...
      {/* CTA */}
      <section className="py-16 bg-brand-500 text-white relative overflow-hidden rounded-none">
         ...
         <div className="max-w-[1200px] mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-6 relative z-10">
            <div className="flex items-center gap-4 text-center md:text-left">
               <div className="w-14 h-14 bg-white/20 rounded-full flex items-center justify-center shadow-inner hidden md:flex"><MapPin size={28} /></div>
               <div>
                  <h3 className="font-extrabold text-4xl text-dark-900">Combo Foz Turismo SM</h3>
                  <p className="text-dark-800 text-sm">O melhor de Foz com o melhor preço. Cataratas + Itaipu + Transfer.</p>
               </div>
            </div>
            <Link href="/products" className="bg-dark-900 text-white px-8 py-4 rounded-none font-bold hover:bg-black transition-colors shadow-lg uppercase tracking-wide">
               Quero meu Combo
            </Link>
         </div>
      </section>
        ...
        <section className="py-20 bg-gray-50">
           <div className="max-w-[1200px] mx-auto px-4">
              <div className="mb-10 text-center">
                 <h2 className="text-4xl md:text-5xl font-extrabold text-dark-900">Sabores e Compras</h2>
      ...
      <section className="py-20 bg-brand-50 border-t border-brand-100">
         <div className="max-w-[1200px] mx-auto px-4 text-center">
            <h2 className="text-4xl md:text-5xl font-extrabold text-dark-900 mb-4">Vem com a Foz Turismo SM!</h2>
